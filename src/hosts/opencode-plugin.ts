  ...
  const tools: Record<string, OpenCodeToolDef> = {
    ...
    queue_update: def(CONTRACTS.queue_update,
      [
        ...
        { name: "finisherSource", type: "string", required: false, description: "for a finisher item: WHAT it lands (branch/tag/sha in the cwd). Required for landed evidence — without it a finisher's runtime failure verdict stands as usual" },
